...
\restrict DdawMAHU8ASFzhYUotpotgWdWF39czlP6JlZZrXyzzJtMJYHLVduWPeOj3gQ8gC
...
SELECT pg_catalog.setval('public.appointments_id_seq', 142, true);
...
SELECT pg_catalog.setval('public.devices_id_seq', 50, true);
...
SELECT pg_catalog.setval('public.envanter_id_seq', 109, true);
...
SELECT pg_catalog.setval('public.kasa_islemleri_id_seq', 301, true);
...
\unrestrict DdawMAHU8ASFzhYUotpotgWdWF39czlP6JlZZrXyzzJtMJYHLVduWPeOj3gQ8gC
